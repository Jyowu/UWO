...
void realizableKE_BCS3<BasicMomentumTransportModel>::boundEpsilon()
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> realizableKE_BCS3<BasicMomentumTransportModel>::rCmu
(
...
template<class BasicMomentumTransportModel>
void realizableKE_BCS3<BasicMomentumTransportModel>::correctNut
(
    const volTensorField& gradU,
    const volScalarField& S2,
    const volScalarField& magS
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix> realizableKE_BCS3<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
realizableKE_BCS3<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMomentumTransportModel>
realizableKE_BCS3<BasicMomentumTransportModel>::realizableKE_BCS3
(
...
template<class BasicMomentumTransportModel>
bool realizableKE_BCS3<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void realizableKE_BCS3<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;

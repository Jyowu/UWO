...
#include "RNGkEpsilon_BCS3_kande.H"
#include "fvModels.H"
...
tmp<volScalarField>
RNGkEpsilon_BCS3_kande<BasicMomentumTransportModel>::boundEpsilon()
{
...
template<class BasicMomentumTransportModel>
void RNGkEpsilon_BCS3_kande<BasicMomentumTransportModel>::correctNut()
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
RNGkEpsilon_BCS3_kande<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
RNGkEpsilon_BCS3_kande<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
...
template<class BasicMomentumTransportModel>
RNGkEpsilon_BCS3_kande<BasicMomentumTransportModel>::RNGkEpsilon_BCS3_kande
(
...
:
    ...
    Cmu_    (dimensioned<scalar>::lookupOrAddToDict("Cmu",      this->coeffDict_, 0.0845)),
    C1_     (dimensioned<scalar>::lookupOrAddToDict("C1",       this->coeffDict_, 1.42)),
    C2_     (dimensioned<scalar>::lookupOrAddToDict("C2",       this->coeffDict_, 1.68)),
    C3_     (dimensioned<scalar>::lookupOrAddToDict("C3",       this->coeffDict_, 0.0)),
    sigmak_ (dimensioned<scalar>::lookupOrAddToDict("sigmak",   this->coeffDict_, 0.71942)),
    sigmaEps_(dimensioned<scalar>::lookupOrAddToDict("sigmaEps",this->coeffDict_, 0.71942)),
    eta0_   (dimensioned<scalar>::lookupOrAddToDict("eta0",     this->coeffDict_, 4.38)),
    beta_   (dimensioned<scalar>::lookupOrAddToDict("beta",     this->coeffDict_, 0.012)),
...
template<class BasicMomentumTransportModel>
bool RNGkEpsilon_BCS3_kande<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void RNGkEpsilon_BCS3_kande<BasicMomentumTransportModel>::correct()
{
    ...
    (
     ...
     ==
        (C1_ - R)*alpha()*rho()*GCorr*epsilon_()/k_()

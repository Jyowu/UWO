...
void realizableKE_BCS4_Ri<BasicMomentumTransportModel>::boundEpsilon()
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> realizableKE_BCS4_Ri<BasicMomentumTransportModel>::rCmu
(
...
template<class BasicMomentumTransportModel>
void realizableKE_BCS4_Ri<BasicMomentumTransportModel>::correctNut
(
    const volTensorField& gradU,
    const volScalarField& S2,
    const volScalarField& magS
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
realizableKE_BCS4_Ri<BasicMomentumTransportModel>::kSource() const
{
...
template<class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
realizableKE_BCS4_Ri<BasicMomentumTransportModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicMomentumTransportModel>
realizableKE_BCS4_Ri<BasicMomentumTransportModel>::realizableKE_BCS4_Ri
(
...
template<class BasicMomentumTransportModel>
bool realizableKE_BCS4_Ri<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void realizableKE_BCS4_Ri<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    if (curvatureSwirlTools_.active())
    {
        ...
        curvatureSwirlData4Ri swirlData = curvatureSwirlTools_.evaluate
        (
            U,
            gradU,
            rho,

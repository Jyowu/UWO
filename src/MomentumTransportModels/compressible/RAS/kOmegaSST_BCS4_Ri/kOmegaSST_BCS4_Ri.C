...
kOmegaSST_BCS4_Ri<BasicMomentumTransportModel>::kOmegaSST_BCS4_Ri
(
...
template<class BasicMomentumTransportModel>
bool kOmegaSST_BCS4_Ri<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void kOmegaSST_BCS4_Ri<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
